...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['nex',				'nex',			'Composer',						 'https://x.com/NexR3AL',		'2e3b70'],
			['cinder',				'cinder',			'Composer',						 'https://youtube.com/@datdosg',		'2e3b70'],
			...
			['Stinko',				'stinkern',			'',						 'https://stinkernn.carrd.co',		'777777'],
			['Eggy in Space',		'bgArtist',		'',					 'https://x.com/Eggy_in_Space',		'99999'],
			['Koiko',		'bgArtist',		'',					 '',		'999999'],
			[''],
			['Psych Engine Team'],
